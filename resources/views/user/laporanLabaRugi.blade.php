                          ...
                          <div class="d-flex justify-content-between">
                              <div class="col-md-2 pl-0">
                                  <div class="form-group">
                                      ...
                                      <select class="pl-1 padding-select groupbyYear" style="border-radius: 3px;" id="search">
                          ...
                          <table id="datatables" class="table table-striped table-no-bordered table-hover"
                              ...
                              <tbody>
                                  ...
                                  @for ($i = 0; $i < sizeof($bebanArray); $i++)
                                    ...
                                    @if (isset($array[$i]['nama']))
                                      ...
                                      @if ($bebanArray[$i]['saldo_akhir'][$j] != 0)
                                        <tr>
                                          <td style="width:60%;padding-left: 3rem!important;">
                                            {{$bebanArray[$i]['kode'][$j]}} - {{$bebanArray[$i]['nama'][$j]}}
                                          </td>
                                          <td style="width:15%">
                                  ...
                                  <tr>
                                    ...
                                    <td style="width:15%"></td>
                                    <td class="text-right" style="width:10%">
                                      <strong class="text-danger">Rp{{strrev(implode('.',str_split(strrev(strval($sum - $sum_biaya)),3)))}}</strong>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td style="width:60%">
                                  ...
                                  <tr>
                                    <td style="width:60%;padding-left: 1.5rem!important;">
                                      <strong>Pendapatan Lain-Lain</strong>
                                    </td>
                                    <td style="width:15%"></td>
                                    <td style="width:15%"></td>
                                    <td style="width:10%"></td>
                                  ...
                                  <tr>
                                    ...
                                    <td style="width:15%"></td>
                                    <td style="width:15%"></td>
                                    <td class="text-right" style="width:10%"> Rp{{strrev(implode('.',str_split(strrev(strval($sum - $sum_biaya)),3)))}}</td>
                                  </tr>
                              </tbody>
                          </table>
                      </div>
